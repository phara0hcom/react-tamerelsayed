...
const About = () => {
    return <section className="section-about" id="section-about">
            ...
            <div className="row">
                <div className="col-1-of-2">
                    <h3 className="heading-tertiary u-margin-bottom-small">
                        Grafics Designer turned Web Designer
                    </h3>
                    <p className="paragraph">
                        In an earlier life I was a salesperson but was
                        always interested in technology and the web. So I
                        started learning on my own and got the opportunity
                        at Dell to switch up my career. I also went back to
                        school and started to work at Creative Clicks since
                        they had more possibilities for me to grow and
                        become a Web-Designer. During my career as a whole I
                        always tried to improve my knowledge. And since I
                        feel I outgrew my role within Creative Clicks I'm
